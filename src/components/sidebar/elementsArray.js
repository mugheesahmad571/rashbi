...
export const elements = [{ title: "קטגוריות", icon: <MdOutlineTableChart size={25} />, to: '/categories' }, { title: "קטגוריות משנה", icon: <MdWindow size={25} />, to: "/subcategories" }, { title: "קישורים", icon: <BsShare size={25} />, to: "/links" }, { title: "ייעוץ", icon: <BiSolidVideoPlus size={25} />, to: "/consultation" }, { title: "בקשות", icon: <FaUserPlus size={25} />, to: "/requests" }, { title: "הגדרה", icon: <BsFillGearFill size={25} />, to: "/definition" }, { title: "לימודים יומיים", icon: <FiBookOpen size={25} />, to: "/daily-studies" }];
