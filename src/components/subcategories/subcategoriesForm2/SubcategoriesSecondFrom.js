...
import "./subcategoriesSecondFrom.css";
import { Label, Input, Button } from "../../index"
import { FaCheck } from "react-icons/fa6";

export default function SubcategoriesSecondFrom() {
                    ...
                    <div className='row justify-content-end mt-5 social_bgCardImg'>
                        ...
                        <div className='col-lg-11 text-center my-5'>
                            <div className='row justify-content-between'>
                                <Button route={"/subcategory-form"} title="אישור" icon={<FaCheck className='approvalIcon' />} ParentClass={"col-lg-5 me-3 text-start"} buttonClass={"px-3 py-2"} linkClass={"approvalBtn"} />
